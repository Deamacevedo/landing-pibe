// QuienEs Script - Cards deslizables para biografía

document.addEventListener('DOMContentLoaded', function() {
    const cardsContainer = document.getElementById('quien-es-cards');
    const prevButton = document.getElementById('quien-es-prev');
    const nextButton = document.getElementById('quien-es-next');
    ...
    function animateBiographyCards() {
        const cards = cardsContainer.querySelectorAll('.biography-card');
